...
public static class GuidPrefabSpawnMenu
{
    ...
    public static void SpawnCamera()
        => GuidPrefabSpawner.SpawnPrefab(PostProcessingCamera, spawnRelativeToSelection: true, lookAtTarget: true, unpackPrefab: true);

    [MenuItem("TohruTheDragon/Scene Assets/Spawn Mirror")]
    public static void SpawnMirror()
        => GuidPrefabSpawner.SpawnPrefab(VRCMirror, spawnRelativeToSelection: true, lookAtTarget: false, unpackPrefab: true);
}
#endif
